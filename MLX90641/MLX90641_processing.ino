// MLX90641_processing.ino
// Prints 16x2 temperature matrix to Serial Monitor for
// visualization on a heat map in Processing (CSV format, 1-line output)
// Adapted by: D. Dubins
// Date: 08-Dec-25
//
  ...
  if (isNewDataAvailable()) {
    ...
    for (int r = 0; r < 12; r++) {    // rows
      for (int c = 0; c < 16; c++) {  // columns
        ...
        Serial.print(T_o[r * 16 + c], 1);  // putting the data in a 16x12 grid
      }
    }
    Serial.println();
  } else {
